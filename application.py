...
def get_id():
    ...
    matches = df[df["Product Name"].astype(str).str.contains(name, case=False)]
...
if __name__ == "__main__":
    # Use 0.0.0.0 to make the app accessible externally within the Elastic Beanstalk environment
